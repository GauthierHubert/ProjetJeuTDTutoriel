...
//		addEnemy(WOLF);
	...
	public void addEnemy(int enemyType) {
		...
		switch (enemyType) {
		case ORC:
			enemies.add(new Orc(x, y, 0, 0, this));
			break;
		case BAT:
			enemies.add(new Bat(x, y, 0, 0, this));
			break;
		case KNIGHT:
			enemies.add(new Knight(x, y, 0, 0, this));
			break;
		case WOLF:
			enemies.add(new Wolf(x, y, 0, 0, this));
			break;
		}
	}
	...
	private int getNewBarWidth(Enemy e) {
		return (int) (HPBarWidth * e.getHealBarFloat());
	}
